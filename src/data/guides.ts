...
export type GuideSection = {
  heading: string;
  // One string renders one paragraph; an array renders one paragraph each.
  // A section used to be capped at a single <p>, which pushed long passages
  // into 150-190 word walls — the two worst on the site were both safety
  // sections, where scannability matters most.
  text?: string | string[];
  bullets?: string[];
  ordered?: string[];
  quote?: string;
...
const methodGuides: GuideArticle[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: 'Why mushrooms last nine days at the farm and three at home', text: [
        'Post-harvest handling research puts the optimum for mushrooms at 32–34°F with 95% relative humidity, which gives a shelf life of roughly 7 to 9 days. At 36°F — still a cold fridge by any home standard — that window falls to 3 to 5 days, because surface browning, stem elongation, and veil opening all accelerate.',
        'Home refrigerators run around 37–40°F and much drier than 95%, so the honest expectation for most mushrooms is a handful of days, not a week. That is the single biggest reason mushrooms bought on Sunday look tired by Wednesday, and it is why the coldest shelf beats a fancier container every time.'
      ] },
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: 'Slime is the signal that ends it', text: [
        'Sliminess is the one sign with no workaround. It is a wet bacterial film on the cap surface, and it does not cook off — it carries a sour taste straight into the pan and no amount of browning covers it. The test is your fingertips, not your eyes: run a finger across a cap and see whether it drags.',
        'A good mushroom feels dry and faintly suedelike; a spoiled one feels like it has been wiped with oil. Once one mushroom in a pack is genuinely slimy, check the rest by hand rather than by sight, because the ones underneath it usually went first.'
      ] },
      { heading: 'Wrinkled and light is not spoiled', text: [
        'The most common mistake is throwing away perfectly good mushrooms because they shrivelled. Wrinkling is water loss, which is the opposite problem to spoilage, and it concentrates flavour rather than ruining it. A wrinkled mushroom that still smells of nothing much is a soup mushroom, a gravy mushroom, or a braise mushroom — put it somewhere with liquid, where the texture never mattered.',
        'It is only a problem if you wanted it whole and glossy on a plate. Mushrooms that have dried to the point of being hard and leathery are also still usable: treat them like a dried mushroom and rehydrate them.'
      ] },
      { heading: 'Dark caps, black gills, and bruises', text: [
        'Mushrooms brown as they age the way a cut apple does, and the gills of a button mushroom open from pale pink to chocolate brown to near black as the cap flattens out. None of that is spoilage. A darkened cremini browns faster in a pan than a bright white one because it has already given up water, and mature open gills make a noticeably deeper mushroom sauce.',
        'Portobellos have black gills the day you buy them. What you are checking on a dark mushroom is whether the darkness is dry or wet: dry and even is age, while a dark patch that is damp and spreading outward from a point is rot.'
      ] },
      { heading: 'What a bad mushroom smells like', text: [
        'The smell test is the most reliable of the three, and the easiest to do badly. Open the container and put your nose over the whole batch rather than sniffing one mushroom — spoilage smells are concentrated in the trapped air. A fresh mushroom smells faintly of damp earth and almost nothing else; some varieties, like shiitake and matsutake, smell distinctly of themselves and always have.',
        'What you are listening for is a change in character rather than strength: sour, fishy, or a sharp ammonia note. Any of those, and the batch goes out even if it looks fine. Smell beats appearance every time, because a mushroom can be well into breaking down before its surface shows it.'
      ] },
      { heading: 'Fuzz: mold, or the mushroom itself?', text: [
        'Fine white fluff around the base of a stem or between mushrooms in a cluster is usually mycelium — the fungus that grew the mushroom, still alive and still growing. It is dry, it sits where the mushroom met its growing medium, and it smells earthy. That batch is fine.',
        'Mold is different: it sits on the cap rather than the base, it is often green, grey, or blue-tinged, it looks damp or cottony, and it comes with a musty smell. Because mushrooms are soft and full of water, food-safety guidance for high-moisture foods is to discard the item rather than cut the mold away — the threads spread further than the visible patch.',
        'When you genuinely cannot tell the two apart, use the smell and the surface underneath: dry and earthy stays, damp and musty goes.'
      ] },
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: 'Why raw mushrooms freeze badly', text: [
        'Water expands as it freezes. Inside a raw mushroom that water sits in intact cells, so the ice crystals puncture the cell walls from the inside out. Nothing puts those walls back — when the mushroom thaws, it slumps and leaks the water it was holding, and you get a grey, limp piece that steams instead of browning.',
        'Cooking first drives off most of that water before it can do the damage, which is why a sautéed mushroom comes out of the freezer as recognisably a mushroom and a raw one comes out as a wet sponge. This is also why you should never refreeze mushrooms that have thawed: the second round of ice crystals works on tissue that has already been broken once.'
      ] },
      ...
      { heading: 'The sauté method, in detail', text: [
        'This is the one to use unless you have a reason not to. Work in batches wide enough that the mushrooms sit mostly flat — a crowded pan steams, and steamed mushrooms carry their water into the freezer with them. Use a little oil rather than butter, because butter solidifies oddly when frozen and browns again unevenly on reheating.',
        'Stop when the pan looks dry and the edges are properly browned, not merely softened: any liquid still in the pan is liquid that becomes ice. Skip the garlic, herbs, wine, and cream — aromatics fade or turn bitter over months, and dairy splits on thawing. Season those in when you cook the mushrooms for the dish they are actually going into.'
      ] },
      { heading: 'The steam-blanch method, for volume', text: [
        'Blanching is how commercial packers do it, and it is worth knowing if you have bought several pounds cheap. Steam the pieces over boiling water for 3 to 5 minutes depending on thickness, until they are heated through and slightly translucent, then plunge them into ice water to stop the cooking and drain them thoroughly. Steaming beats boiling here because boiled mushrooms absorb water rather than losing it.',
        'Blanched mushrooms keep a month or so longer than sautéed ones, because the brief cooking deactivates the enzymes that dull flavour over time, but they come out softer and without any browning. They are best where they will be simmered anyway.'
      ] },
      { heading: 'When freezing raw is actually fine', text: [
        'There is one honest use for raw frozen mushrooms: anything that ends up in liquid and cooks for a long time. Stock, broth, a long-simmered soup, a bolognese. In those dishes the texture was never going to survive anyway, and the flavour transfers fine.',
        'If you are doing it, slice the mushrooms first, freeze them in a single layer, bag them, and use them within a month or two — and cook them straight from frozen, without thawing. Shiitake stems and mushroom trimmings are the best candidates of all, since a scrap bag in the freezer becomes stock later at no cost.'
      ] },
      { heading: 'Portion flat, portion small', text: [
        'How you bag mushrooms matters nearly as much as how you cook them. A flat bag freezes through in a fraction of the time a lumpy one takes, which means smaller ice crystals and less damage, and it thaws evenly and stacks like a file. Press out as much air as you can — air is what causes freezer burn, the dry greyish patches that taste of nothing.',
        'Then portion for the way you actually cook: roughly a cup per bag covers a pasta sauce or a risotto, and it is far easier to use two bags than to hack a portion off a frozen block.'
      ] },
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: 'Prep: slice thin, slice even, do not wash', text: [
        'Brush or wipe the mushrooms rather than rinsing them. Water on the surface simply extends the drying time, and mushrooms that are about to lose 90 percent of their weight in moisture do not need any help getting wetter.',
        'Slice about 1/4 inch thick — thinner dries faster and rehydrates quicker but turns brittle and loses pieces; much thicker risks a slice that feels dry outside while holding moisture in the middle, which is the single most common way a jar goes mouldy weeks later. Small mushrooms can be halved, and very small ones dried whole if you are patient.',
        'Trim anything soft, bruised, or damp before it goes on the tray: drying preserves a mushroom, it does not improve one.'
      ] },
      ...
      { heading: 'Oven method', text: [
        'An oven works if you accept less control. Set it as low as it goes — 150–170°F on most ovens, which is already above ideal — and prop the door open with a wooden spoon so the moisture escapes instead of recirculating. Use wire racks over sheet pans so air reaches both sides, and turn the slices once an hour.',
        'Most batches finish in 2 to 4 hours, but check from 90 minutes because the higher temperature means the margin between dried and toasted is narrow. If your oven has a convection setting, use it; if it has a dedicated dehydrate mode, use that and follow the dehydrator timings instead.'
      ] },
      ...
      { heading: 'The step almost everyone skips: conditioning', text: [
        'Conditioning is what separates a jar that lasts a year from one that grows mould in November. Individual slices finish at slightly different moisture levels, and sealing them together lets the wetter ones share their moisture with the rest.',
        'So: cool the batch completely, pack it loosely into a clear jar at about two-thirds full, seal it, and leave it a week — shaking it once a day so nothing settles into a damp clump. Watch the inside of the glass. Any condensation, any softness returning to the slices, and the whole batch goes back on the trays for another hour or two. Only after a clear week does it go into permanent storage.'
      ] },
      ...
      { heading: 'Mushroom powder, the best by-product', text: [
        'Do not throw away the broken pieces and dust at the bottom of the tray. Blitz dried mushrooms in a spice grinder or blender until they are a fine powder, and you have the most useful seasoning in the cupboard: a spoonful stirred into a stew, a gravy, a risotto, or a burger mix adds savoury depth with no soaking and no texture to accommodate.',
        'Shiitake and porcini powder are the strongest. Store it exactly like the slices, airtight and dark, and expect the aroma to fade a little faster than whole pieces because there is so much more surface area.'
      ] },
      { heading: 'What drying does and does not do', text: [
        'Drying removes the water that bacteria and moulds need, which is why a properly dried mushroom keeps for a year at room temperature. It does not make anything safe that was not safe already.',
        'It does not neutralise the toxins in a misidentified mushroom, and it does not rescue a mushroom that was already slimy or sour when it went on the tray — start with mushrooms that were market-purchased or verified by an expert who handled the actual specimen, and start with mushrooms you would happily have cooked that day. Some varieties, including morels, must be cooked after rehydrating rather than eaten as-is.'
      ] },
...
const speciesGuides: GuideArticle[] = [
  ...
  },
  {
    ...
    sections: [
      { heading: 'The default: quarter-inch slices', text: [
        'If you do not know what a recipe wants, slice **about 1/4 inch (6 mm)** thick and you will rarely be wrong. That thickness is enough for the slice to hold its shape and take colour on both faces, and thin enough to cook through in the time a pan takes to dry out. Thinner slices shrink to almost nothing and tend to go leathery.',
        'Thicker ones stay pale in the middle while the outside browns. Slice down through the cap and stem in one motion so each piece keeps that classic mushroom silhouette, which is partly cosmetic and partly practical — the stem section holds the slice together.'
      ] },
      ...
      { heading: 'Stems: keep, trim, or bin', text: [
        '**Most stems are perfectly good food** and get thrown away for no reason. On button, cremini and portobello the stem is the same flesh as the cap, and only the dry base needs removing.',
        '**Shiitake is the real exception:** its stem stays tough and woody no matter how long you cook it, so pull it off and keep it for stock rather than the pan. Enoki and shimeji grow from a solid clump at the base — cut that off in one go and the strands separate on their own.',
        'On a portobello you may also want to scrape the dark gills out with a teaspoon. Not for safety, but because they bleed a grey-black colour into anything pale, like a cream sauce or a risotto.'
      ] },
      ...
      { heading: 'Fluting: the decorative spiral cut', text: [
        'Fluting is the classic French garnish cut — a series of shallow curved grooves carved from the crown of a button mushroom down to its edge, giving a spiral, almost flower-like pattern.',
        'It is **pure decoration** and it is fiddly, so it belongs on a plated dish rather than a weeknight pan. Use small, firm, very white button mushrooms and a small sharp paring knife.'
      ], ordered: [
        'Hold the mushroom in your non-knife hand.',
        'Rest the blade near the centre of the cap at a shallow angle.',
        'Rotate the mushroom against the blade while drawing the knife down and outward, so the mushroom turns and the knife barely moves.',
        'Each pass lifts a thin curl and leaves one groove. Space five or six evenly around the cap.'
      ] },
      { heading: 'Cooking a fluted mushroom', text: 'Cook them gently in butter with a little lemon juice. That keeps them pale and makes the grooves stand out — browning them hard fills in the pattern and defeats the point. Expect to waste the first several while you find the angle.' },
  ...
  },
  {
    ...
    sections: [
      { heading: 'Sourcing and the slice test', text: [
        'Cook puffball only from a reputable market or from a wild sample verified by a qualified expert who handled the actual specimen — not a photo, not an app, not a comparison against pictures online. **Never eat an unknown wild mushroom.**',
        'One check matters enough to repeat on every puffball, including ones you are confident about. Cut it in half from top to bottom and look at the cut face. An edible puffball is pure white, uniformly firm, and **completely featureless inside**, with no structure of any kind.',
        'Two things you might see instead. **Both mean discard:**'
      ], bullets: [
        '**A yellow, olive, brown, or purple tint.** The spores have started to develop; the mushroom is past eating and will taste bitter.',
        '**The faint silhouette of a cap, gills, or a stem.** It is not a puffball at all but the immature button of another mushroom, and some of those are deadly.'
      ] },
      { heading: 'What the slice test does not tell you', text: 'It is a **safety habit, not an identification method**. Cutting a mushroom open does not tell you the specimen is a puffball — only that a specimen you already had verified has not been mistaken for something with internal structure. The verification has to come first, from a market or an expert who handled it.' },
      { heading: 'What it actually tastes like', text: [
        'Very mild, and closer in character to a fresh cheese or firm tofu than to a woodland mushroom. There is a clean, faintly nutty savour and almost none of the dark, earthy depth of a cremini or porcini. The texture is what people remember: dense and custardy when it is cooked well, a little like a thick slice of aubergine that has held its shape.',
        'That mildness makes it a carrier rather than a star. It takes garlic, herbs, browned butter, soy, miso, or a hot chilli oil and gives them a substantial body to sit on, which is why so many puffball recipes are really seasoning recipes.'
      ] },
      { heading: 'Cut it into slabs, not cubes', text: [
        'This is the decision that most affects the result. Puffball is **close to 90 per cent water**, so it needs as much pan contact as you can give it and as little trapped moisture as possible.',
        'A 1/2-inch slab has two broad flat faces that brown, and it holds together when you turn it. Cubes have six small faces, never sit still long enough to colour, and release their water into a crowded pan, where the whole lot simmers grey.',
        'If the puffball is very large, cut it into steaks first and only then decide whether to halve them. A wide slab is easier to handle than it looks, and it can always be cut on the plate.'
      ] },
      { heading: 'Why it browns faster than you expect', text: [
        'Most mushrooms make you wait: cremini and portobello release water for several minutes before the pan is dry enough to brown, which is the whole point of the technique on the pan-cooking page. Puffball behaves differently because you have already removed much of that water by salting and blotting, and because its flesh is soft and open rather than dense.',
        'The surface reaches browning temperature quickly, and it will **go from golden to bitter in under a minute** if you leave it. Set a shorter mental timer than you would for a portobello and look at the third minute rather than the sixth.'
      ] },
  ...
  },
  {
    ...
    sections: [
      { heading: 'Sourcing and safety', text: [
        ...
        'One further caution specific to this species: a minority of people report digestive upset after eating chicken of the woods even when it was correctly identified and properly cooked, and reports cluster around older specimens and around mushrooms taken from conifers or eucalyptus rather than oak.',
        'The practical response is the one experienced cooks use — eat a small portion the first time, cooked through, and wait a day before eating more.'
      ] },
      { heading: 'Only the young growth is worth cooking', text: [
        'This is the single decision that determines whether the meal is good. A young bracket is soft, bright, and faintly moist at the edge; it cuts like a firm chicken breast. As it ages it turns pale, dries out, goes chalky or fibrous, and develops a sour edge that no amount of butter fixes.',
        'Age runs from the outside in, so a large bracket is often worth harvesting for its outer two or three inches alone with the rest discarded. Test with the knife before you commit the pan to it: if a slice crumbles rather than cuts, or if you feel the blade dragging through fibre, that piece is past it.'
      ] },
      { heading: 'What it actually tastes like', text: [
        ...
        'That mildness makes it a carrier. It takes a marinade, a hot sauce, or a breadcrumb coating better than almost any other mushroom, and it is why the buffalo and fried preparations below are the ones most people come back to.'
      ] },
      { heading: 'Chicken of the woods vs hen of the woods', text: [
        'Two different mushrooms with names built to be confused. Chicken of the woods (Laetiporus) grows as a solid, bright orange-and-yellow shelf on the side of a tree, and cooks like a dense slab of meat — it needs long, moist heat to get through the middle.',
        'Hen of the woods, better known as maitake (Grifola frondosa), grows as a grey-brown ruffled cluster at the base of a tree, and cooks in half the time because the fronds are thin. If you have a ruffled, feathery cluster rather than a solid orange shelf, our maitake guide is the page you want; the technique here will overcook it.'
      ] },
