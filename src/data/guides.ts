...
const speciesGuides: GuideArticle[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: 'Why it browns faster than you expect', text: 'Most mushrooms make you wait: cremini and portobello release water for several minutes before the pan is dry enough to brown, which is the whole point of the technique on the pan-cooking page. Puffball behaves differently because you have already removed much of that water by salting and blotting, and because its flesh is soft and open rather than dense. The surface reaches browning temperature quickly, and it will **go from golden to bitter in under a minute** if you leave it. Set a shorter mental timer than you would for a portobello and look at the third minute rather than the sixth.' },
