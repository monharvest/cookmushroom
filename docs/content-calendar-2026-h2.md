...
| 2.3 | `/how-to-freeze-mushrooms/` | Guide (method) | **Shipped 2026-08-17** (hero pending — see `docs/image-briefs/august-2026-heroes-3.md`) — 2,020 words, 5-row method comparison table, backlinks from 5 pages. The frozen-mushrooms guide's "Freezing mushrooms yourself" section trimmed to a pointer at the same time. |
...
| 3.2 | `/how-to-cook-chicken-of-the-woods/` | Guide (species) | Top searched fall foraged species not yet covered. Same safety framing as morels (expert verification, cook thoroughly, note that some people react even to verified specimens — established editorial caution, no medical claims). |
