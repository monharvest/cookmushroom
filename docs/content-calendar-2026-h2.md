...
| # | URL | Type | Why now |
|---|---|---|---|
| 2.1 | `/how-to-store-mushrooms/` | Reference (Article + quickFacts) | Canonical answer for paper bag vs plastic, fridge placement, shelf life by variety. Every one of the 28 guides' storage sections links here — the same leverage play as the cleaning guide. |
